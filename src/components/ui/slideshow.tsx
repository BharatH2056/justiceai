    ...
    <div className="relative w-full h-screen overflow-hidden bg-black flex items-center justify-center">
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-between p-6 pointer-events-none">
        <button
          ...
          className="p-4 rounded-full bg-white/5 border border-white/10 text-white/50 hover:text-white hover:bg-gold/20 hover:border-gold/30 transition-all pointer-events-auto active:scale-95 group"
        >
          ...
          {slides.map((_, i) => (
            <div
              ...
              className={cn(
                ...
                i === current ? "w-12 bg-gold" : "w-4 bg-white/20 hover:bg-white/40"
              )}
            />
          ))}
        </div>
